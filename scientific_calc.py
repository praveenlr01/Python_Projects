...
class calculator:
    def __init__(self):
        ...
        values = ["7", "8", "9", "/", "%", "clear", "Ac", "4", "5", "6", "(", ")", "**", "1", "2", "3", "-", "=", ",",
                  "0", ".", "min", "+", "sin", "asin", "cos", "acos", "tan()", "pow", "log10", "max", "abs", "floor",
                  "pie", "e", "log", "ceil", "degrees", "radians"]
        ...
        for txt in values:
            ...
            if (txt == "="):
                ...
                btn.grid(row=row, column=col, columnspan=3, padx=2, pady=0)
